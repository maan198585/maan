...
{
extent = new ExtentReports(System.getProperty("user.dir")+"/test-output/myOwnreport.html1",true);
extent.addSystemInfo("HostName","maan")
.addSystemInfo("Environment","Prodouction environment")
.addSystemInfo("User Name","maan");
...
TakesScreenshot ts=(TakesScreenshot)driver;
File source =ts.getScreenshotAs(OutputType.FILE);
FileUtils.copyFile(source,new File("C:\\Users\\harneet\\Desktop\\Selenium Softwares\\screenshot4.png"));}
